...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | This option controls which UI framework will be used throughout your
    | application. You can switch between different UI frameworks and
    | their corresponding form builders.
    |
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Configure your application's branding elements that will be used
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you may configure the settings for each supported UI framework.
    | Each framework has its own specific configuration options.
    |
    */
    'frameworks' => [
        'semantic' => [
        ...
        'preline' => [
            ...
            'enabled' => env('PRELINE_UI_ENABLED', false), // To be enabled when Preline UI is integrated
            'settings' => [
                ...
                'css_classes' => [
                    ...
                    'input' => 'block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500',
                    'field' => 'space-y-1',
    ...
    /*
    |--------------------------------------------------------------------------
    | Legacy Semantic UI Configuration
    |--------------------------------------------------------------------------
    |
    | These are the original Semantic UI settings maintained for
    ...
    */
    ...
    // Sidebar menu density - Available options: "compact", "default", or "cozy"
    'sidebar_density' => env('UI_SIDEBAR_DENSITY', config('ui.frameworks.semantic.settings.sidebar_density', 'default')),

    // Set default theme - Available themes: dark, light
    'theme' => env('UI_THEME', config('ui.frameworks.semantic.settings.theme', 'light')),

    // Button color - Available colors: red, orange, yellow, olive, green, teal, blue, violet, purple, brown, grey, black
    'button_color' => env('UI_BUTTON_COLOR', config('ui.frameworks.semantic.settings.button_color', 'blue')),
    ...
    |--------------------------------------------------------------------------
    |
    | Configure automatic detection of UI frameworks based on your
    | application setup.
    |
    */
    'auto_detect' => [
        'enabled' => env('UI_AUTO_DETECT', false),
        'priority' => ['preline', 'semantic'], // Order of preference
        'detection_methods' => [
            'package_json' => true,
            'css_files' => true,
            'config_hints' => true,
    ...
    |--------------------------------------------------------------------------
    |
    | Define how components map between different UI frameworks.
    | This allows for seamless switching between frameworks.
    |
    */
    'component_mapping' => [
        'button' => [
    ...
    |--------------------------------------------------------------------------
    |
    | Configure performance-related settings for UI frameworks.
    |
    */
    'performance' => [
        'cache_css_classes' => env('UI_CACHE_CSS_CLASSES', true),
        'minify_output' => env('UI_MINIFY_OUTPUT', false),
        'lazy_load_components' => env('UI_LAZY_LOAD', true),
        'preload_critical_css' => env('UI_PRELOAD_CSS', true),
    ],
    ...
    */
    'development' => [
        'show_framework_info' => env('UI_SHOW_FRAMEWORK_INFO', false),
        'debug_css_classes' => env('UI_DEBUG_CSS', false),
        'component_previews' => env('UI_COMPONENT_PREVIEWS', false),
    ],
];
