...
class SelectTest extends PHPUnit_Framework_TestCase
{
	...
	{
		$select = new Select('birth_year');
		$expected = '<select class="ui dropdown" name="birth_year"></select>';
		$result = $select->render();
		$this->assertEquals($expected, $result);

		$select = new Select('color');
		$expected = '<select class="ui dropdown" name="color"></select>';
		$result = $select->render();
		$this->assertEquals($expected, $result);
	}
	...
	public function testSelectCanBeCreatedWithOptions()
	{
		...
		$expected = '<select class="ui dropdown" name="birth_year"><option value="0">1990</option><option value="1">1991</option><option value="2">1992</option></select>';
		$result = $select->render();

		$this->assertEquals($expected, $result);

		$select = new Select('birth_year', array(2001, 2002, 2003));
		$expected = '<select class="ui dropdown" name="birth_year"><option value="0">2001</option><option value="1">2002</option><option value="2">2003</option></select>';
		$result = $select->render();
	...
	public function testCanUseNestedOptions()
	{
		...
		$expected = '<select class="ui dropdown" name="color"><optgroup label="Ontario"><option value="toronto">Toronto</option><option value="london">London</option></optgroup><optgroup label="Quebec"><option value="montreal">Montreal</option><option value="quebec-city">Quebec City</option></optgroup></select>';
		$result = $select->render();
	...
	public function testCanUseNestedOptionsWithoutKeys()
	{
		...
		$select = new Select('color', $options);
		$expected = '<select class="ui dropdown" name="color"><optgroup label="Ontario"><option value="0">Toronto</option><option value="1">London</option></optgroup><optgroup label="Quebec"><option value="0">Montreal</option><option value="1">Quebec City</option></optgroup></select>';
		$result = $select->render();
	...
	public function testCanMixNestedAndUnnestedOptions()
	{
		...
		$select = new Select('color', $options);
		$expected = '<select class="ui dropdown" name="color"><option value="toronto">Toronto</option><option value="london">London</option><optgroup label="Quebec"><option value="montreal">Montreal</option><option value="quebec-city">Quebec City</option></optgroup></select>';
		$result = $select->render();
	...
	public function testSelectCanBeCreatedWithIntegerKeyValueOptions()
	{
		...
		$expected = '<select class="ui dropdown" name="color"><option value="0">Red</option><option value="1">Blue</option></select>';
		$result = $select->render();
		$this->assertEquals($expected, $result);

		$select = new Select('fruit', array('1' => 'Granny Smith', '0' => 'Blueberry'));
		$expected = '<select class="ui dropdown" name="fruit"><option value="1">Granny Smith</option><option value="0">Blueberry</option></select>';
		$result = $select->render();
		$this->assertEquals($expected, $result);
	}
