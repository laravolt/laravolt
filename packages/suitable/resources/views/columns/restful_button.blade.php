@if ($actions->isNotEmpty())
    <div class="flex items-center gap-x-1">
        ...
        @if ($actions->has('destroy'))
            <button type="button"
                ...
                title="Delete" data-modal-target="delete-modal-{{ hash('sha256', $key) }}" onclick="showDeleteModal(this)">
    ...
    @if ($actions->has('destroy'))
        ...
        <div id="delete-modal-{{ hash('sha256', $key) }}" class="hidden fixed inset-0 z-80 overflow-x-hidden overflow-y-auto">
            <div class="flex justify-center pt-10 p-4">
                <div class="fixed inset-0 bg-black/40" onclick="hideDeleteModal('delete-modal-{{ hash('sha256', $key) }}')">
                </div>
                <div
                    ...
                    <div
                        ...
                        <button type="button"
                            ...
                            aria-label="Close" onclick="hideDeleteModal('delete-modal-{{ hash('sha256', $key) }}')">
                    ...
                    <div
                        ...
                        <button type="button"
                            ...
                            onclick="hideDeleteModal('delete-modal-{{ hash('sha256', $key) }}')" autofocus>
                            Cancel
                        </button>
