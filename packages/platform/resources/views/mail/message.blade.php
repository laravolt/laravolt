<table cellspacing="0" cellpadding="0" border="0" width="100%"
    ...
    <tr>
        <td align="center"
            ...
            <p style="-moz-osx-laravolt::font-smoothing: grayscale; -webkit-font-smoothing: antialiased; border: 0; color: {{ config('laravolt.ui.mail.content.color') }}; font: 400 16px/25px apple-system, BlinkMacSystemFont, Arial, 'Segoe UI', 'Helvetica Neue', sans-serif; margin: 0px 0 10px; padding: 0; vertical-align: baseline;">
            {!! $slot !!}
            </p>
        </td>
    </tr>
