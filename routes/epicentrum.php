...
Route::group(
    ...
    function () {
        ...
        Route::middleware('can:'.Permission::MANAGE_USER)->group(function () {
        ...
        Route::middleware('can:'.Permission::MANAGE_ROLE)->resource('roles', RoleController::class)->except('show');

        Route::middleware('can:'.Permission::MANAGE_PERMISSION)->group(function () {
