...
show_completion() {
    ...
    echo ""
    echo "Next steps:"
    echo "1. Access the SHAR dashboard: http://localhost/workflow/shar"
    echo "2. Create your first workflow: http://localhost/workflow/shar/workflows/create"
    echo "3. Monitor SHAR server: http://localhost:8080/health"
    echo "4. Monitor NATS server: http://localhost:8222"
    echo ""
    echo "API endpoints:"
