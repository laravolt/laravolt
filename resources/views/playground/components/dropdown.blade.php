...
<div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-neutral-800 dark:border-neutral-700" style="position:relative; z-index:1">
    <div class="bg-gray-100 border-b rounded-t-xl py-3 px-4 md:py-4 md:px-5 dark:bg-neutral-800 dark:border-neutral-700">
        <p class="mt-1 text-sm text-gray-500 dark:text-neutral-500">Click, hover, and divider variants</p>
    </div>
    <div class="p-4 md:p-5">
        <div class="flex flex-wrap items-start gap-4">
            ...
            <div class="hs-dropdown [--placement:bottom-left] relative inline-flex">
                ...
                <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-60 bg-white shadow-md rounded-lg dark:bg-neutral-800 dark:border dark:border-neutral-700" role="menu" aria-orientation="vertical" aria-labelledby="hs-dropdown-divider">
                    <div class="py-2 px-3">
            ...
            {{-- Hover Dropdown --}}
            <div class="hs-dropdown [--trigger:hover] [--placement:bottom-left] relative inline-flex" style="z-index:50">
                ...
                <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-48 bg-white shadow-md rounded-lg dark:bg-neutral-800 dark:border dark:border-neutral-700" role="menu" aria-orientation="vertical" aria-labelledby="hs-dropdown-hover">
                    <div class="p-1 space-y-0.5">
